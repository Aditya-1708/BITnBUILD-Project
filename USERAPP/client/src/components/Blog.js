...
<div class="mx-auto max-w-2xl lg:mx-0">
    <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl -translate-x-56">From the blog</h2>
    <p class="mt-2 text-lg leading-8 text-gray-600">Listen what community has to say.</p>
</div>
<div class="mx-auto mt-5 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
    ...
    <div class="relative mt-8 flex items-center gap-x-4">
        ...
        <p class="text-gray-600">Co-Founder /codeVista</p>
        </div>
